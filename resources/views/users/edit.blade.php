...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Editar Usuario/a</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-danger">
                <div class="card-header">
                    <h3 class="card-title">Datos Editar Usuario/a</h3>
                </div>
                <div class="card-body">
                    {{--
                 ...
                 --}}
                    <form action="{{ route('users.update', $usuario->id) }}" method="POST">
                            ...
                            <div class="row mb-0">
                                ...
                                <div class="col-md-6">
                                    <div class="px-5">
                                        <input class="form-check-input  my-3" type="radio" name="state" id="estado1" value=1 {{ $usuario->state == 1 ? 'checked' : "" }}>
                                        <label class="col-md-4 col-form-label text-md-end" for="estado1">
                                            Activo/a
                                        </label>
                                    
                                        <input class="form-check-input my-3" type="radio" name="state" id="estado0" value=0 {{ $usuario->state == 0 ? 'checked' : "" }}>
