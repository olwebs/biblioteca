                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool">
                            <a href="{{ route('editorials.create') }}" class="btn btn-primary"><i class="bi bi-file-plus"></i>
                                Registrar Nueva</a>
                        </button>
                    </div>
                </div>
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="{{ route('editorials.show', $editorial->id)}}" type="button" class="btn btn-info" title="Mostrar"><i class="bi bi-eye"></i></a>
                                            <a href="{{ route('editorials.edit', $editorial->id),'/edit'}}" type="button" class="btn btn-success" title="Editar"><i class="bi bi-pencil"></i></a>
