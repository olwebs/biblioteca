    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('index') }}" class="brand-link">
                <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="Biblioteca Logo"
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                    <li class="nav-item">
                            <a href="{{ route('bookreaders.index') }}" class="nav-link /*active*/">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('books.create') }}" class="nav-link">
                                        <i class="nav-icon bi bi-file-earmark-plus-fill"></i>
                                        <p>Registrar Nuevo</p>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('editorials.index') }}" class="nav-link active">
                                        <i class="nav-icon bi bi-card-list"></i>
                                        <p>Listar Todas</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('editorials.create') }}" class="nav-link">
                                        <i class="nav-icon bi bi-file-earmark-plus-fill"></i>
                                        <p>Registrar Nueva</p>
                                    </a>
                                </li>
